...
const AdvisorRecurringstatementScreen = () => {
    ...
    const memberNameData = {
        ...
        changedText: (text) => setPolicyName(text),
    };
    const policyNoData = {
        title: 'Policy No',
        // palceHolderText: 'Enter your policy no',
        inputValue: policyNo,
        changedText: (text) => setPolicyNo(text),
    };
...
export default AdvisorRecurringstatementScreen
