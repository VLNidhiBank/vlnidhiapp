...
const AdvisorMemberDetailsScreen = () => {
        ...
        <View style={styles.container}>
            ...
            <Pressable style={styles.content} onPress={() =>{navigation.navigate(ScreenConstants?.ADVISOR_TEAM_DETAILS_SCREEN)}}>
                ...
                <View style={{ paddingHorizontal: width / 30, paddingVertical: width / 30, width: width * 0.4, }}>
                    <Text style={{ fontSize: 16, fontFamily: fonts?.PoppinsMedium, color: colors?.black }}>Pratik jadhav</Text>
                    <Text style={{ fontSize: 14, fontFamily: fonts?.PoppinsRegular }}>VL00001</Text>
                </View>
...
export default AdvisorMemberDetailsScreen
