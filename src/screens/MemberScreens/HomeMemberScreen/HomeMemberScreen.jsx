...
const HomeMemberScreen = () => {
  ...
  const DummyData = [
    ...
    { id: 5, icon: RegularEmi_Icon, title: "Regular EMI", subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit", color1: "#3B82F6", color2: "#93C5FD", actionNavigation: () => console?.log('Here') },
